import { useDeleteSupplier } from "@/api-hooks/supplier/supplier.mutation";
import { useGetSupplier } from "@/api-hooks/supplier/supplier.query";
        ...
        component={
          <>
            ...
            <Row>
              <Button
                href={{
                  pathname: routeConstant.SupplierEdit,
